...
class Single_list_tester :public Tester< Single_list<Type> > {
	using Tester< Single_list<Type> >::object;
	using Tester< Single_list<Type> >::command;

public:
	Single_list_tester(Single_list<Type> *obj = 0) :Tester< Single_list<Type> >(obj) {
		// empty
	}
...
template <typename Type>
void Single_list_tester<Type>::process() {
	if (command == "new") {
		object = new Single_list<Type>();
		...
		Single_list<Type> *new_object = new Single_list<Type>();

		*new_object = *object;

		std::cout << "Okay" << std::endl;

		Single_list_tester<Type> tester(new_object);
