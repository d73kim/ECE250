/****************************************************
 * Executable: Lazy_deletion_tree_int_driver
 * Author: Douglas Wilhelm Harder
 * Copyright (c) 2006-13 by Douglas Wilhelm Harder.  All rights reserved.
 *
 * DO NOT EDIT THIS FILE
 *
 * Create an instance of the Lazy_deletion_tree_tester<int> class
...
#include <iostream>
#include "Lazy_deletion_tree_tester.h"
...
int main( int argc, char *argv[] ) {
	...
	if ( argc == 1 || !std::strcmp( argv[1], "int" ) ) {
		...
		Lazy_deletion_tree_tester<int> tester;

		tester.run();
	} else if ( !std::strcmp( argv[1], "double" ) ) {
		Lazy_deletion_tree_tester<double> tester;
