/****************************************************
 * Executable:   Directed_acyclic_graph_driver
 * Author:  Douglas Wilhelm Harder
 * Copyright (c) 2006-8 by Douglas Wilhelm Harder.  All rights reserved.
 *
 * DO NOT EDIT THIS FILE
 *
 * Create an instance of the Directed_acyclic_graph_tester class
...
#include <iostream>
#include "Directed_acyclic_graph_tester.h"

int main() {
	Directed_acyclic_graph_tester tester;
